...
module.exports.igoApply = {
  igoApplyCreateValidation: validateRouteHandler({
    tokenAddress: {
      in: ['body'],
  ...
  getIgoApplyValidation: validateRouteHandler({
    id: {
      in: ['params'],
  ...
  updateIgoApplyValidation: validateRouteHandler({
    id: {
      in: ['body'],
      exists: { errorMessage: 'id is require' },
    },
  ...
  deleteIgoApplyValidation: validateRouteHandler({
    id: {
      in: ['params'],
      exists: { errorMessage: 'id is require' },
    },
